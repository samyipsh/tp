...
class DelTagCommandParserTest {
    ...
    public void parse_validArgs_success() {
        ...
        assertParseSuccess(parser, "1 " + VALID_TAG_HUSBAND,
                new DelTagCommand(firstIndex, new Tag(VALID_TAG_HUSBAND)));
    }
    ...
    public void parse_invalidIndex_failure() {
        ...
        assertParseFailure(parser, "-1 " + VALID_TAG_HUSBAND,
                String.format(DelTagCommandParser.MESSAGE_INVALID_INDEX_AT, 1, DelTagCommand.MESSAGE_PARAMS));
    ...
    public void parse_invalidTag_failure() {
        ...
        assertParseFailure(parser, "1 " + "good guy",
                String.format(DelTagCommandParser.MESSAGE_INVALID_INDEX_AT, 2, DelTagCommand.MESSAGE_PARAMS));
    }
