...
class UntagCommandParserTest {
    ...
    public void parse_validArgs_success() {
        ...
        assertParseSuccess(parser, "1 " + VALID_TAG_HUSBAND,
                new UntagCommand(firstIndex, new Tag(VALID_TAG_HUSBAND)));
    }
    ...
    public void parse_invalidIndex_failure() {
        ...
        assertParseFailure(parser, "-1 " + VALID_TAG_HUSBAND,
                String.format(UntagCommandParser.MESSAGE_INVALID_INDEX_AT, 1, UntagCommand.MESSAGE_PARAMS));
    ...
    public void parse_invalidTag_failure() {
        ...
        assertParseFailure(parser, "1 " + "good guy",
                String.format(UntagCommandParser.MESSAGE_INVALID_INDEX_AT, 2, UntagCommand.MESSAGE_PARAMS));
    }
