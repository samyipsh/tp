...
import seedu.address.storage.JsonContactBookStorage;
...
public class LogicManagerTest {
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + GITHUB_DESC_AMY + LINKEDIN_DESC_AMY + DETAIL_DESC_AMY;
     ...
     */
    private static class JsonContactBookIoExceptionThrowingStub extends JsonContactBookStorage {
        private JsonContactBookIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
